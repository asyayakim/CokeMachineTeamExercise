function updateView() {
    // checking if there is there is a div with id 'bought-cokes' if element exists, get it
    const boughtCokesHTML = document.getElementById('bought-cokes') ? document.getElementById('bought-cokes').innerHTML : '';
    document.getElementById('app').innerHTML = /*HTML*/`
        <div class="flexVertical">
            ...
            <div class="flexVertical">
                ...
                <!-- bought cokes will be here-->
                <div id="bought-cokes" class="boughtCokes" style="display: flex; flex-direction: row;">
               ${boughtCokesHTML}
                <!-- Purchased cokes will appear here -->
            </div>
                <div class="flexHorizontal">
